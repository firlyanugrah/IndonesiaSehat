...
<div class="row">
	<div style="height:auto; padding:10px 20px">
		<div id="logo"><img src="<?=base_url()?>/common/images/logo.png" alt="indonesia sehat"></div>
	</div>
	<div class="divider"></div>
	<div class="col s12 center-align f-large" style="position:absolute; top:300px">
		<h4 style="text-decoration:underline"><b>Maaf, Akun dengan username tersebut sudah ada :(</b></h4>
		<h6>&lt;--Kami akan membawa anda ke halaman home--&gt;</h6>
	</div>
</div>
...
<!--Custome script-->
<script type="text/javascript" src="<?=base_url();?>common/js/script.js"></script>
</body>
</html>