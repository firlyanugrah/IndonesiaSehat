...
<link type="text/css" rel="stylesheet" href="<?=base_url();?>assets/bower_components/bootstrap/dist/css/bootstrap.min.css"  media="screen,projection"/>
...
<link type="text/css" rel="stylesheet" href="<?=base_url();?>common/css/shop-homepage.css">
...
<header class="row">
	<div style="height:auto; padding:10px 20px">
		<div id="logo"><a href="<?=base_url()?>"><img src="<?=base_url()?>/common/images/logo.png" alt="indonesia sehat"></a></div>
	</div>
	<div class="divider"></div>
	<div class="col l12" style="margin-bottom: 50px">
		<div class="col l1"></div>
		<div class="col l11"><h4>HI, FIRLY FIRDAUS</h4></div>
	</div>
</header>